...
IMG0=json.loads(re.search(r'const IMG=(\{.*\});',parts['part_img.js'],re.S).group(1))
single=single.replace('<title>Green Ocean — Plants, Planters & Gifts</title>',
  '<title>Green Ocean — Plants, Planters & Gifts</title>\n<link rel="icon" type="image/png" href="'+IMG0['favicon']+'">',1)
...
<link rel="icon" type="image/png" href="FAVPATH">
<link rel="apple-touch-icon" href="FAVPATH">
...
'''.replace('HEROPATH',paths['hero']).replace('FAVPATH',paths['favicon'])
